...
public class WarriorLegsController : MonoBehaviour
{
    // Components
    Animator animator;
    Rigidbody2D rb;
    ...
    private void Dash()
    {
        ...
        CreateDashWind();
        StartCoroutine(WarriorDashCoroutine(dashPower: 100));
    }
    ...
    private IEnumerator WarriorDashCoroutine(float dashPower)
    {
